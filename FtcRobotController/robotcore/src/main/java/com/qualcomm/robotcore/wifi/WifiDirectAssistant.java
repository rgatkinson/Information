...
public class WifiDirectAssistant {
    ...
    private WifiDirectAssistant(Context var1) {
        ...
        this.g = (WifiP2pManager) var1.getSystemService(Context.WIFI_P2P_SERVICE);
        this.f = this.g.initialize(var1, Looper.getMainLooper(), null);
        this.h = new d(null);
        this.i = new a(null);
        this.j = new c(null);
        this.k = new b(null);
    ...
    private void a(Event var1) {
        if (this.n != var1 || this.n == Event.PEERS_AVAILABLE) {
            this.n = var1;
            if (this.w != null) {
    ...
    public void setCallback(WifiDirectAssistantCallback var1) {
        this.w = var1;
    }
    ...
    public enum ConnectStatus {
        ...
        static {
            ConnectStatus[] var0 = new ConnectStatus[]{NOT_CONNECTED, CONNECTING, CONNECTED, GROUP_OWNER, ERROR};
        }
    }
    ...
    public enum Event {
        ...
        static {
            Event[] var0 = new Event[]{DISCOVERING_PEERS, PEERS_AVAILABLE, GROUP_CREATED, CONNECTING, CONNECTED_AS_PEER, CONNECTED_AS_GROUP_OWNER, DISCONNECTED, CONNECTION_INFO_AVAILABLE, ERROR};
        }
    }

    public interface WifiDirectAssistantCallback {
        void onWifiDirectEvent(Event var1);
    }
        ...
        public void onReceive(Context var1, Intent var2) {
            ...
            if ("android.net.wifi.p2p.STATE_CHANGED".equals(var3)) {
                ...
                if ("android.net.wifi.p2p.CONNECTION_STATE_CHANGE".equals(var3)) {
                    NetworkInfo var4 = var2.getParcelableExtra("networkInfo");
                    WifiP2pInfo var5 = var2.getParcelableExtra("wifiP2pInfo");
