...
public class PeerDiscovery implements RobocolParsable {
    ...
    public PeerDiscovery(PeerType var1) {
        this.a = var1;
    }
    ...
    public void fromByteArray(byte[] var1) throws RobotCoreException {
        if (var1.length < 13) {
            ...
            switch (var2.get()) {
                case 1:
                    this.a = PeerType.fromByte(var2.get());
                    return;
                default:
            }
        }
    ...
    public enum PeerType {
        ...
        static {
            PeerType[] var0 = new PeerType[]{NOT_SET, PEER, GROUP_OWNER};
            a = values();
        }
        ...
        public static PeerType fromByte(byte var0) {
            PeerType var1 = NOT_SET;

            try {
                PeerType var4 = a[var0];
                return var4;
