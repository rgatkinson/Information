...
public class ReadXMLFileHandler {
    ...
    private ControllerConfiguration a() throws IOException, XmlPullParserException, RobotCoreException {
        String var1 = this.m.getAttributeValue(null, "name");
        String var2 = this.m.getAttributeValue(null, "serialNumber");
    ...
    private ControllerConfiguration a(boolean var1) throws IOException, XmlPullParserException {
        String var2 = this.m.getAttributeValue(null, "name");
        int var3 = -1;
        String var4 = ControllerConfiguration.NO_SERIAL_NUMBER.toString();
        if (var1) {
            var4 = this.m.getAttributeValue(null, "serialNumber");
        } else {
            var3 = Integer.parseInt(this.m.getAttributeValue(null, "port"));
        }
        ...
        while (true) {
            ...
            if (var6 == 2 && var7.equalsIgnoreCase(DeviceConfiguration.ConfigurationType.SERVO.toString())) {
                int var9 = Integer.parseInt(this.m.getAttributeValue(null, "port"));
                ServoConfiguration var10 = new ServoConfiguration(var9, this.m.getAttributeValue(null, "name"), true);
    ...
    private ControllerConfiguration b(boolean var1) throws IOException, XmlPullParserException {
        ...
        while (true) {
            ...
            if (var6 == 2 && var7.equalsIgnoreCase(DeviceConfiguration.ConfigurationType.MOTOR.toString())) {
                int var9 = Integer.parseInt(this.m.getAttributeValue(null, "port"));
                MotorConfiguration var10 = new MotorConfiguration(var9, this.m.getAttributeValue(null, "name"), true);
                var5.set(var9 - 1, var10);
            }
    ...
    private DeviceConfiguration c() {
        ...
        DeviceConfiguration var2 = new DeviceConfiguration(Integer.parseInt(this.m.getAttributeValue(null, "port")));
        var2.setType(var2.typeFromString(var1));
        var2.setName(this.m.getAttributeValue(null, "name"));
    ...
    private ControllerConfiguration d() throws IOException, XmlPullParserException, RobotCoreException {
        ...
        int var3 = Integer.parseInt(this.m.getAttributeValue(null, "port"));
        ...
        while (true) {
            ...
            if (var6 == 2) {
                if (var7.equalsIgnoreCase(DeviceConfiguration.ConfigurationType.SERVO.toString())) {
                    int var11 = Integer.parseInt(this.m.getAttributeValue(null, "port"));
                    ServoConfiguration var12 = new ServoConfiguration(var11, this.m.getAttributeValue(null, "name"), true);
                    var4.set(var11 - 1, var12);
                } else if (var7.equalsIgnoreCase(DeviceConfiguration.ConfigurationType.MOTOR.toString())) {
                    int var8 = Integer.parseInt(this.m.getAttributeValue(null, "port"));
                    MotorConfiguration var9 = new MotorConfiguration(var8, this.m.getAttributeValue(null, "name"), true);
    ...
    public List<ControllerConfiguration> parse(InputStream is) throws RobotCoreException {
        ...
        try {
            ...
            for (int var3 = this.m.getEventType(); var3 != 1; var3 = this.m.next()) {
                ...
                if (var3 == 2) {
                    if (var4.equalsIgnoreCase(DeviceConfiguration.ConfigurationType.MOTOR_CONTROLLER.toString())) {
                        this.a.add(this.b(true));
                    }

                    if (var4.equalsIgnoreCase(DeviceConfiguration.ConfigurationType.SERVO_CONTROLLER.toString())) {
                        this.a.add(this.a(true));
                    }

                    if (var4.equalsIgnoreCase(DeviceConfiguration.ConfigurationType.LEGACY_MODULE_CONTROLLER.toString())) {
                        this.a.add(this.b());
                    }

                    if (var4.equalsIgnoreCase(DeviceConfiguration.ConfigurationType.DEVICE_INTERFACE_MODULE.toString())) {
                        this.a.add(this.a());
                    }
                }
            }
