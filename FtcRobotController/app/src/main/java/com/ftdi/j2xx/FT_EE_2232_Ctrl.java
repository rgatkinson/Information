...
class FT_EE_2232_Ctrl extends FT_EE_Ctrl
    {
    FT_EE_2232_Ctrl(FT_Device var1) throws D2xxException {
        super(var1);
    ...
    short programEeprom(FT_EEPROM var1) {
        ...
        if(var1.getClass() != FT_EEPROM_2232D.class) {
            ...
            try {
                ...
                var2[10] = this.mEepromType;
                if(var2[1] != 0 && var2[2] != 0) {
                    boolean var6 = false;
                    var6 = this.a(var2, this.mEepromSize - 1);
    ...
    FT_EEPROM readEeprom() {
        ...
        try {
            for(int var3 = 0; var3 < this.mEepromSize; ++var3) {
