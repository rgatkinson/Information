...
class e extends k
{
    ...
    short a(final FT_EEPROM ft_EEPROM) {
        ...
        try {
            ...
            final int n = this.a(ft_EEPROM.Product, array, this.a(ft_EEPROM.Manufacturer, array, 10, 7, true) + (2 + ft_EEPROM.Manufacturer.length()), 8, true) + (2 + ft_EEPROM.Product.length());
            if (ft_EEPROM.SerNumEnable) {
                final int n2 = this.a(ft_EEPROM.SerialNumber, array, n, 9, true) + (2 + ft_EEPROM.SerialNumber.length());
            }
