...
class FT_EE_232A_Ctrl extends FT_EE_Ctrl
    {
    FT_EE_232A_Ctrl(FT_Device var1) {
        super(var1);
    }
    ...
    FT_EEPROM readEeprom() {
        ...
        try {
            ...
            for(var3 = 0; var3 < 64; ++var3) {
                var2[var3] = this.readWord((short)var3);
            }
    ...
    int getUserSize() {
        int var1 = this.readWord((short)7);
        int var2 = (var1 & '\uff00') >> 8;
        var2 /= 2;
        var1 = this.readWord((short)8);
        int var3 = (var1 & '\uff00') >> 8;
        var3 /= 2;
        int var4 = 10 + var2 + var3 + 1;
        var1 = this.readWord((short)9);
        int var5 = (var1 & '\uff00') >> 8;
        var5 /= 2;
    ...
    byte[] readUserData(int var1) {
        ...
        if(var1 != 0 && var1 <= this.getUserSize() - 1) {
            short var6 = (short)(63 - this.getUserSize() / 2 - 1);
            var6 = (short)(var6 & '\uffff');
