...
public class ModernRoboticsNxtServoController implements I2cController.I2cPortReadyCallback, ServoController {
   ...
   public ModernRoboticsNxtServoController(ModernRoboticsUsbLegacyModule var1, int var2) {
      this.a = var1;
      this.d = var2;
