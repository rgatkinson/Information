...
public class AdafruitColorSensor extends ColorSensor implements I2cController.I2cPortReadyCallback {
   ...
   public AdafruitColorSensor(DeviceInterfaceModule var1, int var2) {
      this.f = var2;
      this.a = var1;
