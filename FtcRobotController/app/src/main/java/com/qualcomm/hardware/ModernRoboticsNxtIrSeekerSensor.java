...
public class ModernRoboticsNxtIrSeekerSensor extends IrSeekerSensor implements I2cController.I2cPortReadyCallback {
   ...
   public ModernRoboticsNxtIrSeekerSensor(ModernRoboticsUsbLegacyModule var1, int var2) {
      this.a = var1;
