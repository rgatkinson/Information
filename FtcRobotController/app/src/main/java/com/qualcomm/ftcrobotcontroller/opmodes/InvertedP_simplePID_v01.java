...
public class InvertedP_simplePID_v01 extends OpMode implements SensorEventListener {
   ...
   private static final float kI = 1.0E-5F;
   ...
   private void calculatePID() {
      ...
      this.I += 1.0E-5F * this.currentError * (float)this.lDeltaTime;
