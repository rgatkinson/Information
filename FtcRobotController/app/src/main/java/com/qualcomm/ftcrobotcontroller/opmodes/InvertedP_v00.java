...
public class InvertedP_v00 extends OpMode implements SensorEventListener {
   ...
   private void calculatePID() {
      ...
      this.P = 3.0F * this.fError;
      this.I += 0.0F * this.fError * (float)this.lDeltaTime;
      this.D = 0.03F * this.fAngleRate / (float)this.lDeltaTime;
   }
