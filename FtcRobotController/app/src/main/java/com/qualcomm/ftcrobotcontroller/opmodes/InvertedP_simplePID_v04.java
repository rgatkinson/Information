...
public class InvertedP_simplePID_v04 extends OpMode implements SensorEventListener {
   ...
   private static final float kD = 5.0E-7F;
   private static final float kDA = 0.0F;
   private static final float kI = 2.0E-6F;
   private static final float kM = 1.0F;
   private static final float kP = 0.004F;
   float D = 0.0F;
   float I = 0.0F;
   float P = 0.0F;
   Context context;
   ...
   private void calculatePID() {
      ...
      this.P = 0.004F * this.currentError;
      this.I += 2.0E-6F * this.currentError * (float)this.lDeltaTime;
      this.D = 5.0E-7F * this.currentErrorRate;
   }
   ...
   private void processGyro(SensorEvent var1) {
      ...
      if(Math.abs(this.currentAngleRate) < 0.05F) {
