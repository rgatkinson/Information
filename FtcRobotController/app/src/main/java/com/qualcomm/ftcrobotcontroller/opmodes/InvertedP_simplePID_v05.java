...
public class InvertedP_simplePID_v05 extends OpMode implements SensorEventListener {
   private static final float F_INITIAL_ANGLE = 0.0F;
   private static final float GYRO_THRESHOLD = 0.02F;
   ...
   private static final float kI = 1.0E-6F;
   ...
   private void calculatePID() {
      ...
      this.I += 1.0E-6F * this.currentError * (float)this.lDeltaTime;
   ...
   private void processGyro(SensorEvent var1) {
      ...
      if(Math.abs(this.currentAngleRate) < 0.02F) {
