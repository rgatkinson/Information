...
public class InvertedP_simplePID_v03 extends OpMode implements SensorEventListener {
   private static final float F_INITIAL_ANGLE = 0.0F;
   private static final float GYRO_THRESHOLD = 0.07F;
   ...
   private void processGyro(SensorEvent var1) {
      ...
      if(Math.abs(this.currentAngleRate) < 0.07F) {
