...
public class K9TeleOp extends OpMode
{
    ...
    public void loop() {
        ...
        final float n4 = (float)this.scaleInput(clip);
        final float n5 = (float)this.scaleInput(clip2);
        ...
        this.telemetry.addData("left tgt pwr", "left  pwr: " + String.format("%.2f", n5));
        this.telemetry.addData("right tgt pwr", "right pwr: " + String.format("%.2f", n4));
    }
