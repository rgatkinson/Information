/*============================================================================
* 
* (C) Copyright 2015, Future Technology Devices International Ltd.
* ============================================================================
*
...
charge from FTDI Chip. The driver supports FTDI¡¦s full complement of USB bridge, 
...
¡Dd2xx.jar
  Android Java D2xx library V2.03.00.000

¡D\doc
  Javadoc for Android Java D2xx API

¡D\TN_147_Java_D2xx_for_Android_Demo_Source
  Demo applications: Supports 232R¡B245R¡B232H¡B2232H¡B4232H¡BX_SERIES
...
Updates to support FT4222H Rev B
Two new APIs: FT4222 I2C master readEx & writeEx for I2C combined message support.
Update GPIO API for rev. B.


2.01.00.00

Add support for FT4222H
